    ...
    return(
        ...
        <label className="shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md bg-white p-1">
          ...
          <span  className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${
            isChecked === 'triangular' ? 'text-primary bg-blue-200' : 'text-body-color' }`}>
                Triangular
          </span>
          <span className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${isChecked === 'trapezoidal' ? 'text-primary bg-blue-200' : 'text-body-color'}`}>
                Trapezoidal
          </span>
        </label> 
        </>
